...
export const CUSTOMER_REGISTRY: CustomerEntry[] = [
  ...
  {
    clientId: "samuel-wright",
    clientName: "Samuel Wright",
    clientEmail: "samuel.wright@email.com",
    agentId: "agent_3",
    agentName: "Priya Patel",
    tenantId: "Tenant_B",
  ...
  {
    clientId: "tina-morrison",
    clientName: "Tina Morrison",
    clientEmail: "tina.morrison@email.com",
    agentId: "agent_3",
    agentName: "Priya Patel",
    tenantId: "Tenant_B",
  ...
  },
  {
    ...
    clientEmail: "uma.patel@email.com",
    agentId: "agent_3",
    agentName: "Priya Patel",
    tenantId: "Tenant_B",
